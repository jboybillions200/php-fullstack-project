...
<?php include('layout/header.php') ?>
                ...
                <form action="account.php" id="account-form" method="post">
                  ...
                  <p  style="color: green;"><?php if(isset($_GET['message'])) { echo $_GET['message']; } ?></p>
                    ...
                    <div class="form-group">
                        ...
                        <input type="password" name="confirmPassword" id="account-password-confirm" class="form-control" placeholder="password" required>
                    </div>
                    <div class="form-group">
    ...
    <!--Orders-->  
    <section id="orders" class="orders container my-2 py-2">
